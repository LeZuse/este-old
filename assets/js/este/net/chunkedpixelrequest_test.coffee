suite 'este.net.ChunkedPixelRequest', ->
  ...
  arrange = ->
    request = new ChunkedPixelRequest uri, randomStringFactory, srcCallback

  suite 'send one request', ->
